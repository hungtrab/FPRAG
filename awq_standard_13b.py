...
class GroupWiseAWQAsymmetricL2Quantizer:
    ...
    def quantize_model_sequential(self, calibration_data, n_samples=500, layer_batch_size=8):
        """
...
def main():
    parser = argparse.ArgumentParser(
        description="Group-Wise AWQ with ASYMMETRIC quantization + L2 Salience for Llama-2-13B",
    ...
    parser.add_argument("--output-dir", type=str, default="./quantized_models/llama2_13b_gw_awq_asym_l2",
                       help="Output directory")
    parser.add_argument("--model-path", type=str, default="meta-llama/Llama-2-13b-hf",
                       help="Model name or local path")
    parser.add_argument("--seed", type=int, default=42, help="Random seed")
    parser.add_argument("--calib-dataset", type=str, default="c4",
                       choices=["c4", "wikitext2", "wikitext2-simple"],
                       help="Calibration dataset")
    # CHANGED DEFAULT: 16 -> 8 for Llama-2-13B (larger model needs smaller batches)
    parser.add_argument("--layer-batch-size", type=int, default=8,
                       help="Number of layers to calibrate simultaneously. "
                            "Llama-2-13B requires smaller batches than 7B models due to larger size.")
    ...
    print(f"Layer Batch Size: {args.layer_batch_size} (Adjusted for 13B memory footprint)")
    print("=" * 80)
