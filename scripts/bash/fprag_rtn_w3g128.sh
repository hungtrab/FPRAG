...
# W3G128 RTN baseline and RTN+JS/heuristic flip for:
#   - Mistral-7B-v0.3
#   - Meta-Llama-3.1-8B
#   - Qwen2.5-7B
#
# Usage:
#   bash fprag_rtn_w3g128.sh --ppl
#   bash fprag_rtn_w3g128.sh --lm-eval
#   bash fprag_rtn_w3g128.sh --ppl --lm-eval
#   bash fprag_rtn_w3g128.sh --tune-flip --ppl --lm-eval
...
HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-./hf_datasets_cache_rtn_w3g128}"
WANDB_PROJECT="${WANDB_PROJECT:-fprag_rtn_w3g128}"
RUN_PPL=0
RUN_LM_EVAL=0
TUNE_FLIP=0
FORCE="${FORCE:-0}"
...
mkdir -p quantized_models logs dataset_cache calibration_cache eval_results_rtn_w3g128 artifacts "$HF_DATASETS_CACHE"
